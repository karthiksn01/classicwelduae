...
<html lang="en">
  ...
  <body class="bg-weld-dark text-white overflow-x-hidden font-sans">
    <div id="app">
      ...
      <!-- Products Hero -->
      <section class="relative pt-48 pb-24 hero-gradient">
         <div class="absolute inset-0 overflow-hidden">
             <div class="absolute -top-20 -left-20 w-96 h-96 bg-weld-orange blur-[150px] opacity-10 rounded-full"></div>
         </div>
         <div class="max-w-7xl mx-auto px-4 relative z-10 text-center">
             <h1 class="text-4xl md:text-5xl font-bold mb-4">Industrial Grade <span class="text-gradient">Equipment</span></h1>
             <p class="text-gray-400 max-w-2xl mx-auto">Browse our complete catalog of high-performance welding machines, safety gear, and consumables.</p>
         </div>
      </section>
          ...
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div class="flex flex-col lg:flex-row gap-8">
                      ...
                      <div class="glass p-6 rounded-xl sticky top-24">
                          <h3 class="text-xl font-bold mb-4 text-white">Categories</h3>
                            <ul class="space-y-3 mb-8" id="category-filter">
                                <li><a href="#" class="text-weld-orange font-bold flex justify-between items-center category-link" data-category="All">All Products</a></li>
                            </ul>

                          <div class="mt-8 mb-8 border-t border-zinc-800 pt-8">
                              <a href="/wishlist" class="flex items-center justify-center gap-2 w-full bg-weld-orange/10 hover:bg-weld-orange text-weld-orange hover:text-white border border-weld-orange/30 hover:border-weld-orange font-bold py-3 px-4 rounded-xl transition-all">
                  ...
                  <div class="w-full lg:w-3/4">
                      ...
                      <!-- Top Bar -->
                      <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4 glass p-4 rounded-xl border border-white/5">
                          <div class="relative w-full md:w-64">
                              <i class="ph ph-magnifying-glass absolute left-3 top-1/2 -translate-y-1/2 text-gray-400"></i>
                              <input type="text" id="search-input" placeholder="Search products..." class="w-full bg-black border border-white/10 rounded-lg pl-10 pr-4 py-2 text-white focus:outline-none focus:border-weld-orange">
                          </div>
                          <div class="flex items-center gap-2 text-sm text-gray-400">
                              <span>Sort by:</span>
                              <select id="sort-select" class="bg-black border border-white/10 rounded-lg px-3 py-2 text-white focus:outline-none focus:border-weld-orange cursor-pointer">
