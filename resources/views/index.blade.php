    ...
    <nav class="fixed top-0 w-full z-50 glass transition-all duration-300" id="navbar">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
          ...
          <div class="flex items-center space-x-4">
            ...
            <a href="/admin/login" class="text-gray-300 hover:text-white transition-colors" title="Admin Login"><i
                class="ph ph-user text-xl"></i></a><button onclick="toggleTheme()"
              class="text-gray-300 hover:text-white transition-colors" title="Toggle Theme"><i
                class="ph ph-sun theme-toggle-icon text-xl"></i></button>
          </div>
          <div class="-mr-2 flex md:hidden">
            <button type="button" id="mobile-menu-btn"
              class="bg-zinc-800 inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-white hover:bg-zinc-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
      ...
      <div class="hidden md:hidden bg-zinc-900 border-t border-zinc-800" id="mobile-menu">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          <a href="/"
            class="text-gray-300 hover:text-white hover:bg-zinc-800 block px-3 py-2 rounded-md text-base font-medium">Home</a>
          <a href="/products"
            class="text-gray-300 hover:text-white hover:bg-zinc-800 block px-3 py-2 rounded-md text-base font-medium">Products</a>
          <a href="/#services"
            class="text-gray-300 hover:text-white hover:bg-zinc-800 block px-3 py-2 rounded-md text-base font-medium">Services</a>
          <a href="/about"
            class="text-gray-300 hover:text-white hover:bg-zinc-800 block px-3 py-2 rounded-md text-base font-medium">About</a>
          <a href="/contact"
            class="text-gray-300 hover:text-white hover:bg-zinc-800 block px-3 py-2 rounded-md text-base font-medium">Contact</a>
          <a href="/feedback"
            class="text-gray-300 hover:text-white hover:bg-zinc-800 block px-3 py-2 rounded-md text-base font-medium">Feedback</a>
          <a href="/admin/login"
            class="text-gray-300 hover:text-white hover:bg-zinc-800 block px-3 py-2 rounded-md text-base font-medium">Admin
            Login</a>
        </div>
      </div>
    </nav>
    ...
    <section id="services" class="py-24 bg-weld-dark border-t border-zinc-900 relative overflow-hidden">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div
            class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
            <div
              class="w-14 h-14 rounded-xl bg-amber-500/10 flex items-center justify-center text-weld-orange text-3xl mb-6 group-hover:scale-110 transition-transform">
              <i class="ph-fill ph-gear"></i>
            </div>
            <h3 class="text-xl font-bold mb-3 text-white">Equipment Supply</h3>
            <p class="text-gray-400 text-sm leading-relaxed mb-4">
              We supply high-quality welding machines, consumables, and accessories for industrial, commercial, and
              professional use.
            </p>
            <ul class="text-xs text-gray-500 space-y-1">
              <li class="flex items-center gap-2"><i class="ph-bold ph-check text-weld-orange"></i> MIG / TIG / ARC
                Machines</li>
              <li class="flex items-center gap-2"><i class="ph-bold ph-check text-weld-orange"></i> Safety Gear & Tools
              </li>
            </ul>
          </div>
          ...
          <div
            class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
            <div
              class="w-14 h-14 rounded-xl bg-blue-500/10 flex items-center justify-center text-blue-400 text-3xl mb-6 group-hover:scale-110 transition-transform">
              <i class="ph-fill ph-package"></i>
            </div>
            <h3 class="text-xl font-bold mb-3 text-white">Bulk & Industrial</h3>
            <p class="text-gray-400 text-sm leading-relaxed mb-4">
              We specialize in bulk and industrial welding tool supply with competitive dealer pricing and consistent
              availability.
            </p>
            <ul class="text-xs text-gray-500 space-y-1">
          ...
          <div
            class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
            <div
              class="w-14 h-14 rounded-xl bg-green-500/10 flex items-center justify-center text-green-400 text-3xl mb-6 group-hover:scale-110 transition-transform">
          ...
          <div
            class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
            <div
              class="w-14 h-14 rounded-xl bg-red-500/10 flex items-center justify-center text-red-400 text-3xl mb-6 group-hover:scale-110 transition-transform">
              <i class="ph-fill ph-fire"></i>
            </div>
            <h3 class="text-xl font-bold mb-3 text-white">Consumables</h3>
            <p class="text-gray-400 text-sm leading-relaxed mb-4">
              We offer a complete range of welding consumables to ensure uninterrupted production and superior weld
              quality.
            </p>
            <ul class="text-xs text-gray-500 space-y-1">
          ...
          <div
            class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
            <div
              class="w-14 h-14 rounded-xl bg-purple-500/10 flex items-center justify-center text-purple-400 text-3xl mb-6 group-hover:scale-110 transition-transform">
              <i class="ph-fill ph-wrench"></i>
            </div>
            <h3 class="text-xl font-bold mb-3 text-white">Expert Consultation</h3>
            <p class="text-gray-400 text-sm leading-relaxed mb-4">
              Not sure which welding equipment fits your application? Our experts help you choose the right tools for
              efficiency.
            </p>
            <ul class="text-xs text-gray-500 space-y-1">
              <li class="flex items-center gap-2"><i class="ph-bold ph-check text-purple-400"></i> Tool Selection Guide
              </li>
              <li class="flex items-center gap-2"><i class="ph-bold ph-check text-purple-400"></i> Industry
                Recommendations</li>
            </ul>
          </div>
          ...
          <div
            class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
            <div
              class="w-14 h-14 rounded-xl bg-teal-500/10 flex items-center justify-center text-teal-400 text-3xl mb-6 group-hover:scale-110 transition-transform">
              <i class="ph-fill ph-arrows-clockwise"></i>
            </div>
            <h3 class="text-xl font-bold mb-3 text-white">After-Sales Support</h3>
            <p class="text-gray-400 text-sm leading-relaxed mb-4">
              We provide reliable after-sales support, warranty handling, and spare parts assistance to ensure
              performance.
            </p>
            <ul class="text-xs text-gray-500 space-y-1">
              <li class="flex items-center gap-2"><i class="ph-bold ph-check text-teal-400"></i> Warranty Assistance
              </li>
          ...
          <div
            class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
            <div
              class="w-14 h-14 rounded-xl bg-yellow-500/10 flex items-center justify-center text-yellow-400 text-3xl mb-6 group-hover:scale-110 transition-transform">
            ...
            <ul class="text-xs text-gray-500 space-y-1">
              <li class="flex items-center gap-2"><i class="ph-bold ph-check text-yellow-400"></i> Safety Best Practices
              </li>
          ...
          <div
            class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
            <div
              class="w-14 h-14 rounded-xl bg-pink-500/10 flex items-center justify-center text-pink-400 text-3xl mb-6 group-hover:scale-110 transition-transform">
              <i class="ph-fill ph-truck"></i>
            </div>
            <h3 class="text-xl font-bold mb-3 text-white">Logistics & Delivery</h3>
            <p class="text-gray-400 text-sm leading-relaxed mb-4">
              We ensure fast, secure, and reliable delivery across the UAE and support international shipping for bulk
              orders.
            </p>
            <ul class="text-xs text-gray-500 space-y-1">
