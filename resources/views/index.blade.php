  ...
  <body class="bg-weld-dark text-white overflow-x-hidden">
    <div id="app">
          ...
          <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden md:block">
              <div class="ml-10 flex items-baseline space-x-8">
                <a href="#home" class="hover:text-weld-orange transition-colors px-3 py-2 rounded-md text-base font-medium">Home</a>
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div class="max-w-3xl animate-fade-in-up">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <button onclick="window.location.href='products.html'" class="bg-weld-orange hover:bg-amber-600 text-white px-8 py-4 rounded-full font-bold transition-all transform hover:scale-105 shadow-lg shadow-amber-500/30 flex items-center justify-center gap-2">
                Shop Now <i class="ph ph-arrow-right font-bold"></i>
              </button>
              <a href="/catalog.pdf" target="_blank" class="glass hover:bg-white/10 text-white px-8 py-4 rounded-full font-bold transition-all flex items-center justify-center gap-2">
      ...
      <section id="products" class="py-20 bg-weld-dark">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="relative w-full h-[400px] bg-zinc-900 rounded-2xl overflow-hidden group border border-white/5">
             <!-- Arrows -->
             <button id="carousel-prev" class="absolute left-4 top-1/2 -translate-y-1/2 z-20 text-white/50 hover:text-white text-5xl transition-colors drop-shadow-md"><i class="ph ph-caret-left"></i></button>
             <button id="carousel-next" class="absolute right-4 top-1/2 -translate-y-1/2 z-20 text-white/50 hover:text-white text-5xl transition-colors drop-shadow-md"><i class="ph ph-caret-right"></i></button>
      ...
      <section id="services" class="py-24 bg-weld-dark border-t border-zinc-900 relative overflow-hidden">
        ...
        <div class="absolute bottom-0 right-0 w-96 h-96 bg-blue-500/5 rounded-full blur-[128px] pointer-events-none"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div class="text-center mb-16">
            ...
            <p class="text-gray-400 max-w-2xl mx-auto text-lg">
              We go beyond just selling tools. We provide end-to-end solutions to ensure your operations run smoothly, safely, and efficiently.
            </p>
          </div>

          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <!-- 1. Welding Equipment Supply -->
            <div class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
              <div class="w-14 h-14 rounded-xl bg-amber-500/10 flex items-center justify-center text-weld-orange text-3xl mb-6 group-hover:scale-110 transition-transform">
                <i class="ph-fill ph-gear"></i>
              </div>
              <h3 class="text-xl font-bold mb-3 text-white">Equipment Supply</h3>
              <p class="text-gray-400 text-sm leading-relaxed mb-4">
                We supply high-quality welding machines, consumables, and accessories for industrial, commercial, and professional use.
              </p>
              <ul class="text-xs text-gray-500 space-y-1">
                <li class="flex items-center gap-2"><i class="ph-bold ph-check text-weld-orange"></i> MIG / TIG / ARC Machines</li>
                <li class="flex items-center gap-2"><i class="ph-bold ph-check text-weld-orange"></i> Safety Gear & Tools</li>
              </ul>
            </div>

            <!-- 2. Bulk & Industrial Supply -->
            <div class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
              <div class="w-14 h-14 rounded-xl bg-blue-500/10 flex items-center justify-center text-blue-400 text-3xl mb-6 group-hover:scale-110 transition-transform">
                <i class="ph-fill ph-package"></i>
              </div>
              <h3 class="text-xl font-bold mb-3 text-white">Bulk & Industrial</h3>
              <p class="text-gray-400 text-sm leading-relaxed mb-4">
                We specialize in bulk and industrial welding tool supply with competitive dealer pricing and consistent availability.
              </p>
              <ul class="text-xs text-gray-500 space-y-1">
                <li class="flex items-center gap-2"><i class="ph-bold ph-check text-blue-400"></i> Factory Supply</li>
                <li class="flex items-center gap-2"><i class="ph-bold ph-check text-blue-400"></i> Dealer Partnerships</li>
              </ul>
            </div>

            <!-- 3. Custom Orders & RFQ -->
            <div class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
              <div class="w-14 h-14 rounded-xl bg-green-500/10 flex items-center justify-center text-green-400 text-3xl mb-6 group-hover:scale-110 transition-transform">
                <i class="ph-fill ph-receipt"></i>
              </div>
              <h3 class="text-xl font-bold mb-3 text-white">Custom Orders</h3>
              <p class="text-gray-400 text-sm leading-relaxed mb-4">
                Request a customized quotation for large-volume or specialized welding requirements with tailored pricing.
              </p>
              <ul class="text-xs text-gray-500 space-y-1">
                <li class="flex items-center gap-2"><i class="ph-bold ph-check text-green-400"></i> Custom Machine Specs</li>
                <li class="flex items-center gap-2"><i class="ph-bold ph-check text-green-400"></i> Project-based Pricing</li>
              </ul>
            </div>

            <!-- 4. Welding Consumables -->
            <div class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
              <div class="w-14 h-14 rounded-xl bg-red-500/10 flex items-center justify-center text-red-400 text-3xl mb-6 group-hover:scale-110 transition-transform">
                <i class="ph-fill ph-fire"></i>
              </div>
              <h3 class="text-xl font-bold mb-3 text-white">Consumables</h3>
              <p class="text-gray-400 text-sm leading-relaxed mb-4">
                We offer a complete range of welding consumables to ensure uninterrupted production and superior weld quality.
              </p>
              <ul class="text-xs text-gray-500 space-y-1">
            ...
            <div class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
              <div class="w-14 h-14 rounded-xl bg-purple-500/10 flex items-center justify-center text-purple-400 text-3xl mb-6 group-hover:scale-110 transition-transform">
                <i class="ph-fill ph-wrench"></i>
              </div>
              <h3 class="text-xl font-bold mb-3 text-white">Expert Consultation</h3>
              <p class="text-gray-400 text-sm leading-relaxed mb-4">
                 Not sure which welding equipment fits your application? Our experts help you choose the right tools for efficiency.
              </p>
              <ul class="text-xs text-gray-500 space-y-1">
                <li class="flex items-center gap-2"><i class="ph-bold ph-check text-purple-400"></i> Tool Selection Guide</li>
                <li class="flex items-center gap-2"><i class="ph-bold ph-check text-purple-400"></i> Industry Recommendations</li>
              </ul>
            </div>

            <!-- 6. After-Sales Support -->
            <div class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
              <div class="w-14 h-14 rounded-xl bg-teal-500/10 flex items-center justify-center text-teal-400 text-3xl mb-6 group-hover:scale-110 transition-transform">
                <i class="ph-fill ph-arrows-clockwise"></i>
              </div>
              <h3 class="text-xl font-bold mb-3 text-white">After-Sales Support</h3>
              <p class="text-gray-400 text-sm leading-relaxed mb-4">
                We provide reliable after-sales support, warranty handling, and spare parts assistance to ensure performance.
              </p>
              <ul class="text-xs text-gray-500 space-y-1">
                <li class="flex items-center gap-2"><i class="ph-bold ph-check text-teal-400"></i> Warranty Assistance</li>
             ...
             <!-- 7. Safety & Training -->
             <div class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
              <div class="w-14 h-14 rounded-xl bg-yellow-500/10 flex items-center justify-center text-yellow-400 text-3xl mb-6 group-hover:scale-110 transition-transform">
                <i class="ph-fill ph-shield-check"></i>
              </div>
              <h3 class="text-xl font-bold mb-3 text-white">Safety Guidance</h3>
              <p class="text-gray-400 text-sm leading-relaxed mb-4">
                We offer basic operational guidance and safety recommendations to help teams use equipment correctly.
              </p>
              <ul class="text-xs text-gray-500 space-y-1">
                <li class="flex items-center gap-2"><i class="ph-bold ph-check text-yellow-400"></i> Safety Best Practices</li>
            ...
            <div class="group p-8 rounded-2xl bg-zinc-900 border border-zinc-800/50 hover:bg-zinc-800/50 hover:border-zinc-700 transition-all duration-300 hover:-translate-y-1">
              <div class="w-14 h-14 rounded-xl bg-pink-500/10 flex items-center justify-center text-pink-400 text-3xl mb-6 group-hover:scale-110 transition-transform">
                <i class="ph-fill ph-truck"></i>
              </div>
              <h3 class="text-xl font-bold mb-3 text-white">Logistics & Delivery</h3>
              <p class="text-gray-400 text-sm leading-relaxed mb-4">
                We ensure fast, secure, and reliable delivery across the UAE and support international shipping for bulk orders.
              </p>
              <ul class="text-xs text-gray-500 space-y-1">
                <li class="flex items-center gap-2"><i class="ph-bold ph-check text-pink-400"></i> Domestic Shipping</li>
